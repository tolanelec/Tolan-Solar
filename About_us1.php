<?php if(preg_match("/MSIE/",getenv("HTTP_USER_AGENT")) || preg_match("/Internet Explorer/",getenv("HTTP_USER_AGENT"))){header('Location:http://localhost/xampp/tolansolar-v1/About_us1.php'); }?>                    
			...
			<form class="quoter" method="post" action="getquote.php" >
				<fieldset ="left">
                    <h3> GET A QUOTE NOW  </h3>
						...
						<input type="textfield" name="email" value="" /></br>
					
						<label for="phone">contact number</label></br>
						<input type="textfield" name="contact" value=""/></br>
			  ...
			  <span id="contents5">
			   <p class="text">Buy lighting products online!</p>
				<UL class="rightmenu">
				
				<LI></LI>
					<LI><img src="images/product-image.jpg" alt="solar panel advert" /></LI>
					<LI> </br> </LI>
					<LI><img src="images/logo_payment_paypal.jpg" alt="paypal logo" /> <img src="images/logo_payment_visa.jpg" alt="visa logo" /></LI>
					<LI></LI>
					<LI>Accepted online</LI>
